...
import it.unibo.model.pickable.impl.MalusLife;
import static org.junit.jupiter.api.Assertions.assertEquals;
import java.awt.Point;
import java.awt.Dimension;

/**
 * This class is used to test the behaviour of the class MalusLife.
 */
class MalusLifeTest {
    ...
    /**
     * This method tests the constructor of the class MalusLife.
     */
    @Test
    void testConstructor() {
        final Point position = new Point(POSITION, POSITION);
        final MalusLife bonusLife = new MalusLife(position, DIMENSION);
    ...
    /**
     * This method tests the method doEffect of the class MalusLife.
     */
    @Test
    void testDoEffect() {
        final Point position = new Point(POSITION, POSITION);
